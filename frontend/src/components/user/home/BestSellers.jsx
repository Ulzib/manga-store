  ...
  return (
    <div className="w-full py-12">
      <div className="relative flex justify-center items-center w-full mb-6">
        <h2 className="text-3xl font-bold text-white">Бестселлер</h2>
        <Link
          href="/books"
            ...
            <CarouselItem key={book._id} className="pl-4 basis-auto pt-10">
              <div className="group relative w-52 bg-[#0F0F0F] rounded-2xl p-4 pt-0 transition-all border border-white/5">
                <Link href={`/books/${book._id}`} className="block">
                  <div className="relative -mt-8 mb-4 mx-auto w-40 aspect-151/223 overflow-hidden rounded-lg transition-transform durantion-500 ease-out group-hover:-translate-y-2 ">
                ...
                <Button
                  ...
                  className="w-full h-11 bg-zinc-800/90 hover:bg-zinc-700 text-white rounded-2xl border-none font-bold text-xs flex items-center justify-center gap-2 transition-colors my-2"
                >
